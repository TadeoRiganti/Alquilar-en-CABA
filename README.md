...
Con esta herramienta, podés **comparar** diferentes barrios y **tomar una decisión informada**, basada en [**datos reales**](https://data.buenosaires.gob.ar/dataset/) sobre transporte, seguridad, servicios y otros puntos de interés.
...
<div align="center"><img width="720px" src="https://github.com/TadeoRiganti/Alquilar-en-CABA/blob/main/kit-de-prensa/Infografias/infografia-capas-de-mapa.png"></div>

Para esta prueba de concepto se condujo una investigacion de usuarios rapida, en la cual se identificaron 3 tematicas que causaban mucha incertidumbre a la hora de alquilar (Urbanismo, Movildad e Inseguridad). Para responderlas se desarrollaron las siguientes [**capas tematicas**](https://github.com/TadeoRiganti/Alquilar-en-CABA/wiki/Sobre-las-capas-tematicas):
  - **Urbanismo:**
    - Comunas y barrios.
...
<div align="center"><img alt="Previsualizacion animada del comportamiento del seguimiento automatico" align="center" src="https://github.com/TadeoRiganti/Alquilar-en-CABA/blob/d84b388e37a1b81e078fbce700d750763e32c47d/kit-de-prensa/Cliparts/gif-carga-automatica.gif"></div>
...
- [**Planilla de seguimiento**](https://docs.google.com/spreadsheets/d/1n8KmH8Q9s2Fp96RFHQW84AAExconjnvSWJ40BhUe-6I/copy)
